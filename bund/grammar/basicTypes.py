...
CODEWORD_REF_TYPE:
    ID | NSID | SPECIAL_TYPE | LAMBDA_TYPE | CURRY_TYPE
;
...
CONDITIONAL_TYPE:
    C_OPEN condition=LAMBDA_TYPE words*=LAMBDA_TYPE C_CLOSE
;
...
DataDef:
    ID | BASETYPE | LIST_TYPE | KV_TYPE | LAMBDA_TYPE | CONDITIONAL_TYPE | REF_TYPE | CURRY_TYPE | PRELIMENARY_EXECUTE_TYPE | DO_EXECUTE_TYPE | NSID | SPECIAL_TYPE
;
